...
con=mysql.connector.connect(host='localhost',user='root',passwd='root',database='quiz')
...
Traceback (most recent call last):
  File "C:\Users\Lenovo\Desktop\CS QUIZ\Quiz_1.py", line 761, in <module>
    con.rollback()
  File "C:\Users\Lenovo\AppData\Local\Programs\Python\Python38-32\lib\site-packages\mysql\connector\connection.py", line 1327, in rollback
    self._execute_query("ROLLBACK")
  File "C:\Users\Lenovo\AppData\Local\Programs\Python\Python38-32\lib\site-packages\mysql\connector\connection.py", line 1339, in _execute_query
    self.cmd_query(query)
  File "C:\Users\Lenovo\AppData\Local\Programs\Python\Python38-32\lib\site-packages\mysql\connector\connection.py", line 920, in cmd_query
    result = self._handle_result(self._send_cmd(ServerCmd.QUERY, query))
  File "C:\Users\Lenovo\AppData\Local\Programs\Python\Python38-32\lib\site-packages\mysql\connector\connection.py", line 567, in _send_cmd
    self._socket.send(
  File "C:\Users\Lenovo\AppData\Local\Programs\Python\Python38-32\lib\site-packages\mysql\connector\network.py", line 163, in send_plain
...
mysql.connector.errors.OperationalError: 2055: Lost connection to MySQL server at 'localhost:3306', system error: 10038 An operation was attempted on something that is not a socket
    ...
    submit = Button(med_frame,command=calc,text="Submit", fg="
OSError: [WinError 10038] An operation was attempted on something that is not a socket
...
Traceback (most recent call last):
  ...
  File "C:\Users\Lenovo\AppData\Local\Programs\Python\Python38-32\lib\site-packages\mysql\connector\network.py", line 163, in send_plain
    raise errors.OperationalError(
mysql.connector.errors.OperationalError: 2055: Lost connection to MySQL server at 'localhost:3306', system error: 10038 An operation was attempted on something that is not a socketwhite", bg="black")
    submit.place(relx=0.5,rely=0.82,anchor=CENTER)
...
if __name__=='__main__':
    start()
try:
    db=cursor.execute("create table student (Name varchar(30)NOT NULL,U_id Int(10) Primary key,password Varchar(50),country Float(15)")
except:
    con.rollback()
    con.close()
sql="insert into student(fname,uname,passW,country)"
try:
    cursor.execute(sql)
    con.commit()
except:
...
con.close()
try:
    bd=cursor.execute("create table subject (S_iD varchar(30)NOT NULL,subject Varchar(50)")
except:
    con.rollback()
    con.close()
dql="insert into subject(S_id,subject) values (%s,%s)"
values=[("CS_1","Computer_Science"),("Phy_1","Physics"),("Eng_1","English"),("Chem_1","Chemistry"),("Math_1","Mathematics")]
try:
    cursor.executemany(dql,values)
    con.commit()
except:
    con.rollback()
con.close()
try:
    cd=cursor.execute("create table results (S_iD varchar(30) NOT NULL,U_id Varchar(50) NOT NULL,Marks integer")
except:
    con.rollback()
    con.commit()
tql="insert into results(S_iD,U_id,score)"
try:
    cursor.execute(tql)
    con.commit()
except:
